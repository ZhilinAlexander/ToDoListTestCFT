//
//  TodoListTestCFTUITests.swift
//  TodoListTestCFTUITests
//
//  Created by Professor on 31/01/2024.
//

import XCTest
import CoreData
@testable import TodoListTestCFT


class TaskTest: XCTestCase {

    lazy var mockPersistantContainer: NSPersistentContainer = {
      let container = NSPersistentContainer(name: "TodoListTestCFT")
